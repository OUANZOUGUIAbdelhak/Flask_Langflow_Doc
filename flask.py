...
class GlassData(db.Model):
    ...
    verre_type = db.Column(db.String(100), nullable=True)
    ...
    compo_solution = db.Column(db.String(100), nullable=True)
...
def add_glass_data():
    ...
    try:
        ...
        new_entry = GlassData(
            ...
            verre_type=data.get('verre_type'),
            sio2=data.get('sio2'),
            b2o3=data.get('b2o3'),
            na2o=data.get('na2o'),
            ...
            compo_solution=data.get('compo_solution'),
...
def download_excel():
    ...
    for entry in glass_data:
        data.append({
            ...
            "Compo solution": entry.compo_solution,
            ...
            "V₀(Si)": entry.v0_si,
            "r²(Si)": entry.r_carre_si,
            "Ordonnée origine (Si)": entry.ordonnee_origine_si,
            "V₀(B)": entry.v0_b,
            "Ordonnée origine (B)": entry.ordonnee_origine_b,
            "V₀(Na)": entry.v0_na,
            "r²(Na)": entry.r_carre_na,
            "Ordonnée origine (Na)": entry.ordonnee_origine_na,
            "V₀(ΔM)": entry.v0_dm,
